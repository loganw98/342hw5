...
public interface Value {
	...
	static class FunVal implements Value { //New in the funclang
		...
		private String _frml;
		private double _n;
		private Exp _body;
		public FunVal(Env env, List<String> formals, String frml, double n, Exp body) {
			_env = env;
			_formals = formals;
			_frml = frml;
			_n = n;
		...
		public String frml() { return _frml; }
	...
	static class NumVal implements Value {
	    ...
	    public String tostring() { 
	    	int tmp = (int) _val;
	    	if(tmp == (int) _val) return "" + tmp;
	    	return "" + _val; 
	    }
	}
	static class BoolVal implements Value {
		private boolean _val;
	    public BoolVal(Object v) {
			_val = (boolean) v;
	...
	static class PairVal implements Value {
	    ...
	    public java.lang.String listToString() {
	    	String result = "(";
